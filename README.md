...
- [`docs/METHODOLOGY.md`](docs/METHODOLOGY.md) — public-facing methodology (Slice 11)
- [`docs/paper/kahzaabu-methodology.md`](docs/paper/kahzaabu-methodology.md) — arXiv-style paper draft v0.1 (Markdown source; pandoc-convertible)
