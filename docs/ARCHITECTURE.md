...
ADRs 0001-0010 in `docs/adr/` document every architectural choice with explicit context and alternatives considered. Slice 10 will add `docs/EVAL_RESULTS.md` with the F1 numbers per stage.
