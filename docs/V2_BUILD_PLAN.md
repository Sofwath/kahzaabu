...
| 10 | Quality evals + prompt regression tests | ✅ done | 0008 | 33 golden fixtures across 6 stages (truth_score 6, matcher 6, contradictions 5, extractor 4, decomposer 4, verifier 8); `kahzaabu eval` CLI with --small (CI) + per-stage filter; macro-F1 + per-class metrics; verified-vs-pinned distinction (24/33 verified); docs/EVAL_RESULTS.md auto-generated; data/eval_history.jsonl append-only audit |
